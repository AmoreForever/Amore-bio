! function(t) {
        ...
        typewrite: function(t, s) {
            if (this.stop !== !0) {
                ...
                o.timeout = setTimeout(function() {
                    var e = 0,
                        r = t.substr(s);
                    if ("^" === r.charAt(0)) { var i = 1; /^\^\d+/.test(r) && (r = /\d+/.exec(r)[0], i += r.length, e = parseInt(r)), t = t.substring(0, s) + t.substring(s + i) }
                    ...
                    o.timeout = setTimeout(function() {
                        if (s === t.length) {
                            ...
                            o.timeout = setTimeout(function() { o.backspace(t, s) }, o.backDelay)
                        } else {
    ...
    }, t.fn.typed.defaults = { strings: ["Это значения по умолчанию...", "Ты знаешь что ты хочешь сделать?", "Используй свое собственное!", "Удачного дня!"], typeSpeed: 0, startDelay: 0, backSpeed: 0, shuffle: !1, backDelay: 500, loop: !1, loopCount: !1, showCursor: !0, cursorChar: "|", attr: null, contentType: "html", callback: function() {}, preStringTyped: function() {}, onStringTyped: function() {}, resetCallback: function() {} }
}(window.jQuery);